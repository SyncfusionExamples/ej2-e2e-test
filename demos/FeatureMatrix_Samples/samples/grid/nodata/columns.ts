...
let col: Object[] = [
    ...
    { field: 'Freight', headerText: 'Freight', textAlign: 'Left',type: 'number', format: 'C2', validationRules: { required: true }, editType: 'numericedit' },
    { field: 'ShipName', headerText: 'Ship Name',type: 'string', textAlign: 'Left' },
    { field: 'OrderDate',format: 'yMd', editType: 'datepickeredit', type:'date' },
    { field: 'ShipCountry', headerText: 'Ship Country',type: 'string', edit: { params: { popupHeight: '300px' } }, editType: 'dropdownedit', textAlign: 'Left' },   
